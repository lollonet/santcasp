...
public:
    ...
    /// Set size of the buffer. Capped at kMaxBufferSize (10000) to prevent
    /// unbounded memory growth (~80KB for int64_t, sorts in <1ms).
    /// @param size requested buffer size
    /// @return actual size set (may be less than requested if capped)
